# 말레이시아·싱가포르 영어캠프 실행문서

2026년 여름방학 말레이시아·싱가포르 영어캠프 준비를 위한 실행 문서 저장소입니다.  
두 아이를 데리고 참가하는 부모 관점에서, 출발 전 준비, 현지 운영, 이동, 비용, 체크리스트를 함께 관리합니다.
...
- [Cost-tracker.md](02-finance/Cost-tracker.md): 확정비, 예상비, 현지 실지출 관리
...
- `09 MEC ACADEMY] LETTER OF OFFER_김윤찬_27 Jul 26.pdf`
- `MEC ACADEMY Student handbook 2026.pptx.pdf`
- `[MEC ACADEMY] LETTER OF OFFER_김종욱(KIM JONGUK) - Sheet1.pdf`

## BMAD 적용 원칙

- `B`: 왜 이 프로젝트를 운영하는지와 기본 전제를 정리
- `M`: 부모 관점의 생활/교육 운영 기준 정리
- `A`: 실제 출국 전 준비와 현지 실행안 정리
- `D`: 확정사항, 리스크, 비용, 체크리스트 통제

## 운영 기준

문서는 여행 감상이 아니라 실제 운영 문서로 사용합니다.  
판단 기준은 다음 네 가지입니다.
